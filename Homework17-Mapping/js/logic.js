...
d3.json(earthquake_url, function(data){
   ...
   var earthquakes = L.geoJSON (quake, {
...
"access_token=pk.eyJ1Ijoic2ljb25nd2FuZyIsImEiOiJjam9sczRpZ3YwMmZuM3BxeG9ubnBsb3FkIn0.KcJFFLjajgyco0xtpjJ4kA");
// satelliteMap: has to insert id
var satelliteMap = L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}', {
  id: 'mapbox.satellite',
  accessToken: 'pk.eyJ1Ijoic2ljb25nd2FuZyIsImEiOiJjam9sczRpZ3YwMmZuM3BxeG9ubnBsb3FkIn0.KcJFFLjajgyco0xtpjJ4kA'
});
//  Define light map
var lightMap = L.tileLayer(
  "https://api.mapbox.com/styles/v1/mapbox/light-v9/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1Ijoic2ljb25nd2FuZyIsImEiOiJjam9sczRpZ3YwMmZuM3BxeG9ubnBsb3FkIn0.KcJFFLjajgyco0xtpjJ4kA")
